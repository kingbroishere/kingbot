...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "6007179358").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "GIFT0NTON"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "GIFT0NTON")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1003034407154").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002564847154"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002564847154"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002894286980"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002991636531"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1002781392044"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://creatingking7_db_user:Alone9090@cluster0.lw5qo5n.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "Cluster0")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "-1003034407154")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "kingbro")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002987699696"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-4807169720")
REQUEST_CHANNEL = (
    int(request_channel)
...
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/+_6ywcJKlLMUyZGM1")
